    ...
    >
      ...
      <div
        className="flex flex-row justify-start 
         ...
         lg:w-[85vw] lg:flex-row lg:items-center lg:mt-[5rem] 
         xl:w-[85vw] xl:flex-row xl:items-center xl:mt-[6rem] xl:justify-around 
      ...
      >
        ...
        >
          <img
            ...
            sm:w-[18rem] sm:h-[19rem]
            md:w-[21rem] md:h-[23rem]
            lg:w-[16rem] lg:h-[19rem]
            xl:w-[17rem] xl:h-[20rem]
        ...
        <div
          ...
          sm:w-[95vw] sm:h-[20rem] sm:pl-[0rem] sm:mt-[1rem] sm:items-center
          md:w-[95vw] md:h-[20rem] md:pl-[0rem] md:mt-[4rem] md:items-center
          lg:mt-[0rem] lg:w-[70%] lg:h-[20rem] lg:flex-col lg:pt-[0rem]
          xl:mt-[0rem] xl:w-[65%] xl:h-[20rem] xl:flex-col 
        ...
        >
          <div
            ...
            sm:text-[4rem]  sm:w-[100%] sm:h-[5rem] sm:items-center 
            md:text-[4.5rem]  md:w-[100%] md:h-[5rem] md:items-center 
            lg:pt-[0rem] lg:mt-[.5rem] lg:text-[3.5rem] lg:items-start
            lg:justify-start lg:h-[5rem]
          ...
          <div
           ...
           v:items-center v:pt-[0rem] v:w-[100vw] v:h-[25vh]
            ...
            md:pt-[0rem] md:items-center md:h-[29vh]
          ...
          >
            <h2
              ...
              v:text-[23px] v:pt-[0]
              sm:text-[2.1rem] sm:pt-[0]
              md:text-[2.8rem] md:pt-[0]
              lg:text-[1.9rem] 
              xl:text-[2.3rem] 
              2xl:text-[2.5rem] 
              text-[#ff914dcc]"
            ...
            <span
              ...
              sm:text-[19px] sm:w-[36rem] sm:text-center sm:leading-[32px] sm:pt-[.2rem]
              md:text-[20px] md:w-[39rem] md:text-center md:leading-[32px] md:pt-[.3rem]
      ...
      v:h-[18rem] v:w-[90vw] v:mt-[3rem]
      sm:h-[22rem] sm:w-[90vw] sm:justify-items-center sm:mt-[0rem]
      md:h-[22rem] md:w-[90vw] md:justify-items-center md:mt-[4rem]
      ...
      ">
        <div className=" flex flex-col sm:items-center sm:justify-center">
          ...
          md:text-[20px] md:items-center md:justify-center
          ...
          <span className="pt-[0.2rem] opacity-[90%] text-[20px] font-medium text-[#FF914D]
           v:text-center v:text-[14px] 
        ...
        <div className=" flex flex-col sm:items-center sm:justify-center md:items-center">
          <span className="text-[20px] 
          v:text-[16px] v:text-center
          sm:text-[20px] sm:items-center sm:justify-center
          md:text-[20px] md:items-center md:justify-center
